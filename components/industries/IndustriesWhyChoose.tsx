...
const features = [
  {
    ...
    description:
      "High-quality industrial steel products with strict quality standards.",
    icon: ShieldCheck,
  },

  {
    title: "Fast Delivery",
    description:
      "Reliable logistics and quick industrial product delivery support.",
    icon: Truck,
  },

  {
    ...
    description:
      "Trusted and certified engineering materials for heavy industries.",
    icon: Award,
  },

  {
    title: "24/7 Support",
    description:
      "Dedicated customer support and industrial assistance anytime.",
    icon: Headphones,
  },
];
      ...
      <div className="relative z-10 mx-auto max-w-[1280px] px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="mx-auto mt-8 max-w-3xl text-base leading-7 text-zinc-600 sm:text-lg sm:leading-8">
            ...
            and trusted industrial solutions with quality assurance, fast
