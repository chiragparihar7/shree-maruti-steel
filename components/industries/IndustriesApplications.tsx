...
const applications = [
  {
    ...
    description:
      "Premium industrial piping and steel solutions for oil & gas industries.",
    icon: Flame,
  },

  {
    ...
    description:
      "Engineering materials and industrial systems for petrochemical plants.",
    icon: Factory,
  },

  {
    title: "Power Plants",
    description:
      "Boiler quality steel products and industrial pipe systems.",
    icon: Cpu,
  },

  {
    ...
    description:
      "Heavy-duty steel products for railway and transportation sectors.",
    icon: TrainFront,
  },

  {
    ...
    description:
      "Structural steel and industrial products for infrastructure projects.",
    icon: Building2,
  },

  {
    title: "Offshore Industries",
    description:
      "Corrosion-resistant materials for offshore industrial environments.",
    icon: Waves,
  },

  {
    title: "Steel Plants",
    description:
      "Industrial-grade steel materials for manufacturing and steel plants.",
    icon: Hammer,
  },

  {
    ...
    description:
      "Trusted engineering solutions for public infrastructure projects.",
    icon: Landmark,
  },
];

const IndustriesApplications = () => {
  return (
      ...
      <div className="relative z-10 mx-auto max-w-[1280px] px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="mx-auto mt-8 max-w-3xl text-base leading-7 text-zinc-600 sm:text-lg sm:leading-8">
            Our premium industrial steel products and engineering materials are
            widely used across heavy industries, infrastructure projects and
            ...
            return (
              ...
              >
                ...
                <div className="relative z-10 flex items-start justify-between">
                  {/* ICON */}
                  <div className="relative flex h-20 w-20 items-center justify-center rounded-[28px] bg-gradient-to-br from-orange-500 to-orange-400 text-white shadow-[0_15px_40px_rgba(249,115,22,0.35)] transition-all duration-700 group-hover:scale-110 group-hover:rotate-3">
...
export default IndustriesApplications;