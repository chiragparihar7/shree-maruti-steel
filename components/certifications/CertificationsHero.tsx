...
const CertificationsHero = () => {
  return (
    <section className="relative overflow-hidden bg-[#fafafa] pt-14 pb-16 sm:pt-18 sm:pb-20 lg:pt-16 lg:pb-24">
      {/* GLOW */}
      <div className="absolute left-[-100px] top-[-100px] h-[320px] w-[320px] rounded-full bg-orange-300/20 blur-[120px]" />

      <div className="absolute bottom-[-100px] right-[-100px] h-[320px] w-[320px] rounded-full bg-orange-400/20 blur-[120px]" />
      ...
      <div className="relative z-10 mx-auto max-w-[1280px] px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="mt-7 max-w-3xl text-base leading-7 text-zinc-600 sm:text-lg sm:leading-8">
            Trusted industrial supplier delivering premium quality steel
            products, certified materials and engineering solutions across
            India.
          </p>
